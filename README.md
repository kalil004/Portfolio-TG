...
Durante o desenvolvimento, exercitei intensamente liderança ao assumir o papel de Product Owner. Desde o início, idealizei a visão do produto final e transformei essa visão em tarefas claras para a equipe. Em várias sprints, precisei avaliar a disponibilidade de cada membro e delegar as atividades de forma estratégica, garantindo que cada um pudesse contribuir dentro de sua área de domínio. A comunicação foi outro ponto central: fui responsável pelo contato direto com o cliente, esclarecendo dúvidas e alinhando expectativas. A cada nova funcionalidade discutida, eu também repassava essas informações para o grupo, garantindo que não houvesse interpretações diferentes e que as entregas fossem feitas de forma consistente com o que havia sido acordado. Minha organização teve papel essencial para manter o time na mesma direção. Estruturei um backlog coerente, priorizando o que era realmente crucial para o cliente e refinando as histórias junto com o Scrum Master. Além disso, ao distribuir as tarefas, sempre considerei o nível de conhecimento de cada integrante, o que ajudou a melhorar o fluxo de trabalho e evitou sobrecargas desnecessárias. Por fim, a resiliência se mostrou indispensável. A API era complexa e, com a equipe reduzida — de cinco integrantes para quatro após a desistência de um membro —, houve momentos em que acumulamos atrasos e alguns imprevistos técnicos apareceram. Mesmo assim, mantive o ritmo e o foco, ajustei o planejamento quando necessário e colaborei para que conseguíssemos entregar o projeto com qualidade, praticamente sem pendências.
