...
Durante o projeto, desenvolvi habilidades como orientação a resultados, autonomia e adaptabilidade. Um exemplo claro disso aconteceu quando o Product Owner do meu grupo saiu do curso, e nosso cliente passou a responder de forma pouco consistente. Essa falta de alinhamento trouxe incertezas sobre as prioridades do produto e sobre quais funcionalidades deveriam ser entregues primeiro. Diante desse cenário, precisei assumir uma postura mais autônoma para evitar que o projeto ficasse parado. Analisei a documentação que já havia sido fornecida, revisei as reuniões anteriores e estruturei uma lista de requisitos mínimos para manter o desenvolvimento ativo. Essa atitude me permitiu tomar decisões técnicas de forma independente, garantindo que o projeto continuasse avançando mesmo sem um direcionamento claro. Além disso, como a ausência do PO exigiu que cada integrante contribuísse em diferentes frentes, precisei atuar tanto no front-end quanto no back-end. Isso reforçou minha adaptabilidade, já que, em diversos momentos, precisei mudar rapidamente de contexto, alternando entre correções de interface, ajustes de API e revisões de arquitetura sempre que surgiam mudanças nos requisitos. Mesmo com essas instabilidades, mantive o foco em entregar uma solução funcional e alinhada às necessidades gerais do cliente, mostrando minha orientação a resultados. Essa experiência me ensinou a lidar com cenários de incerteza, a buscar soluções de forma independente e a ajustar minha abordagem rapidamente sempre que o projeto exigia uma mudança de direção.
...
Durante o desenvolvimento, pude exercitar intensamente minhas habilidades de liderança. Como Product Owner, fui responsável por idealizar o produto final e transformar as necessidades do cliente em funcionalidades claras. Para garantir o andamento do projeto, deleguei tarefas levando em consideração a disponibilidade e o nível de conhecimento de cada membro da equipe, o que ajudou a manter o fluxo de trabalho equilibrado, e também desempenhei um papel essencial na comunicação com o cliente. Mantive contato frequente via Slack e Google Meet para validar funcionalidades, esclarecer pontos que ainda geravam dúvidas e confirmar se o que estava sendo implementado correspondia fielmente às expectativas. Esse alinhamento contínuo evitou retrabalho e garantiu entregas consistentes.
A organização foi outro ponto-chave. Estruturei um backlog coerente e priorizado, focado no que o cliente realmente precisava. Trabalhei junto ao Scrum Master para distribuir as tarefas de forma estratégica no Jira, considerando o tempo disponível de cada integrante e suas habilidades técnicas. Essa divisão clara ajudou o time a manter ritmo e direção mesmo nos períodos mais intensos. A necessidade de resiliência ficou evidente conforme os desafios apareciam. Além da complexidade natural da API, enfrentamos dificuldades concretas: um dos membros precisou abandonar o curso, reduzindo o grupo de cinco para quatro pessoas; algumas funcionalidades demandaram mais tempo que o previsto; e tivemos pequenos atrasos causados por bugs recorrentes na integração. Mesmo assim, mantivemos o foco na qualidade e cumprimos os prazos essenciais, garantindo uma entrega final completa, estável e bem estruturada.
